...
class SharedLocation {
  ...
  factory SharedLocation.fromJson(Map<String, dynamic> json) => SharedLocation(
        ...
        expiresIn: json['expiresIn'] != null
            ? Duration(minutes: json['expiresIn'])
            : null,
      );
}
...
class LocationShareService {
  ...
  final _locationUpdateController =
      StreamController<SharedLocation>.broadcast();
  Stream<SharedLocation> get locationUpdates =>
  ...
  void startSharing(String userId, String userName, {Duration? duration}) {
    _myUserId = userId;
  ...
  Future<void> _updateLocation() async {
    ...
    if (position == null || _myUserId == null || _myUserName == null) return;

    final location = SharedLocation(
      id: '${_myUserId}_${DateTime.now().millisecondsSinceEpoch}',
      userId: _myUserId!,
  ...
  SharedLocation createLocationUpdate(
      Position position, String userId, String userName) {
