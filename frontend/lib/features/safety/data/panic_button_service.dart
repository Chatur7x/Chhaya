...
class PanicButtonService {
  final LocationSafetyService _safetyService;
  ...
  final _panicTriggered = StreamController<void>.broadcast();
  Stream<void> get onPanicTriggered => _panicTriggered.stream;

  PanicButtonService(this._safetyService);

  void startListening() {
    _accelerometerSub = accelerometerEventStream().listen(_onAccelerometerData);
  }
