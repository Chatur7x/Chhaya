...
import '../../../features/stealth/presentation/hidden_inbox_screen.dart';
...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _authenticateWithBiometric() async {
    ...
    try {
      ...
      final success = await biometricService.authenticate(
        reason: 'Authenticate to access Chaaya',
      );
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_showBiometricOption && !_isAuthenticating) ...[
                      GlassContainer(
                        opacity: 0.15,
                        child: InkWell(
                    ...
                    authState.when(
                      data: (success) {
                        ...
                        return ElevatedButton(
                          onPressed: () => _handleLogin(decoyService),
  ...
  Future<void> _handleLogin(DecoyService decoyService) async {
    if (!_formKey.currentState!.validate()) return;

    await decoyService.initialize();
    final password = _passwordController.text;
    final result = await decoyService.authenticate(password);
    ...
    switch (result) {
      case AuthResult.decoy:
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const HiddenInboxScreen()),
        );
        break;
