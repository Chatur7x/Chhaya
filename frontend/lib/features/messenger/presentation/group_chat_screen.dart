    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text(_title, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
                Text(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.info_outline, color: ChaayaTheme.textSecondary),
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 11, color: ChaayaTheme.accent.withOpacity(0.8)),
                ),
              ],
            ),
          ),
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Message ${widget.channel?.name ?? widget.group?.name ?? "group"}',
            ...
            Container(
              ...
              child: IconButton(
                ...
                onPressed: () async {
                  ...
                  if (widget.channel != null) {
                    await svc.sendChannelMessage(widget.channel!.id, text, widget.myId);
                  } else if (widget.group != null) {
                    await svc.sendGroupMessage(widget.group!.id, text, widget.myId);
                  }
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.channel != null) ...[
              Row(
                children: [
                  Icon(widget.channel!.hasPassword ? Icons.lock : Icons.lock_open,
                      size: 16, color: ChaayaTheme.textSecondary),
                  const SizedBox(width: 8),
                  Text(
                    widget.channel!.hasPassword ? 'Password protected' : 'Open channel',
                    style: ChaayaTheme.bodyMedium,
                  ),
                ],
              ),
    ...
    return AlertDialog(
        ...
        children: [
          ...
          if (widget.isChannel) ...[
            ...
            SwitchListTile(
              ...
              title: const Text('Password protected', style: TextStyle(color: ChaayaTheme.textPrimary, fontSize: 14)),
              value: _hasPassword,
            ...
            if (_hasPassword)
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.lock_outline, color: ChaayaTheme.accent),
                ),
              ),
          ],
        ],
      ...
      actions: [
        TextButton(
          ...
          child: const Text('Cancel', style: TextStyle(color: ChaayaTheme.textSecondary)),
        ),
        ElevatedButton(
          onPressed: () {
