      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text('Chhaya', style: ChhayaTypography.largeTitle.copyWith(letterSpacing: 1.0)),
            const SizedBox(height: ChhayaSpacing.md),
            if (errorMessage != null)
              Text(errorMessage!, style: ChhayaTypography.footnote.copyWith(color: ChhayaColors.accentRed))
            else
              const CupertinoActivityIndicator(color: ChhayaColors.labelSecondary),
          ],
        ),
      ),
    );
...
class _AppStartupGateState extends ConsumerState<AppStartupGate> {
  ...
  @override
  Widget build(BuildContext context) {
    if (!_showPinPad && _authenticating) {
    ...
    return CupertinoPageScaffold(
      ...
      child: SafeArea(
        child: Column(
          children: [
            const Spacer(flex: 2),
            const Icon(CupertinoIcons.lock_shield_fill, size: 56, color: ChhayaColors.accentBlue),
                        ...
                        children: row.map((digit) {
                          ...
                          if (digit == '⌫') {
                            return SizedBox(
                              ...
                              child: CupertinoButton(
                                ...
                                child: const Icon(CupertinoIcons.delete_left, color: ChhayaColors.labelPrimary, size: 24),
                              ),
                            );
                          }
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(digit, style: ChhayaTypography.title1.copyWith(fontWeight: FontWeight.w300)),
                              ),
                            ),
                          );
                        }).toList(),
            ...
            CupertinoButton(
              ...
              child: Text('Use Biometrics', style: ChhayaTypography.body.copyWith(color: ChhayaColors.accentBlue)),
            ),
